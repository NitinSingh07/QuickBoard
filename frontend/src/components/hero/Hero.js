...
const Hero = () => {
  return (
    <div
      className="relative flex flex-col items-center justify-center bg-cover bg-center py-20"
      style={{
        backgroundImage: "url('./img/hero.jpg')",
      }}
    >
      <div className="max-w-screen-xl px-4 mx-auto md:flex-row sm:px-6 ml-16">
        <div className="flex items-center md:w-1/2 md:pb-20 md:pt-10 md:pr-10">
          <div className="text-left">
            ...
            <p className="max-w-md mx-auto mt-10 pt-4 text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
