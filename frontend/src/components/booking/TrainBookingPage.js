            ...
            <div>
              ...
              <div>
                ...
                <StyledMenu
                  ...
                  onClose={handleClose}
                >
                  <MenuItem onClick={() => handleMenuItemClick("Mumbai_CST")} disableRipple>
                    Mumbai_CST
                  </MenuItem>
                  <MenuItem onClick={() => handleMenuItemClick("Kolkata_Howrah_Junction")} disableRipple>
                    Kolkata_Howrah_Junction
                  </MenuItem>
                  <MenuItem onClick={() => handleMenuItemClick("Mumbai_Central")} disableRipple>
                    Mumbai_Central
                  </MenuItem>
                  <MenuItem onClick={() => handleMenuItemClick("Delhi_Junction")} disableRipple>
                    Delhi_Junction
                  </MenuItem>
                  <MenuItem onClick={() => handleMenuItemClick("Chennai_Central")} disableRipple>
                    Chennai_Central
                  </MenuItem>
                  <MenuItem onClick={() => handleMenuItemClick("Bengaluru")} disableRipple>
                    Bengaluru
                  </MenuItem>
            ...
            <div>
              ...
              <div>
                ...
                >
                  ...
                  <MenuItem onClick={() => handleMenuItemClick("Vadodara")} disableRipple>
                    Vadodara
                  </MenuItem>
                  <MenuItem onClick={() => handleMenuItemClick("Bengaluru")} disableRipple>
                    Bengaluru
